...
account_sid = 'AC7b45507aa06d09a46534252e80adfb31'
auth_token = 'a8f312261caee98fd05cbfa8d2cc6221'
...
def login_registration_dtls():
    ...
    return render_template('acknowledgment.html', var=full_name ,var1=email_id, var2 = id_proof,
